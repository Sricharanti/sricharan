...
export MMCSD_DEVFS_PARTITION_1=${MMCSD_DEVFS_ENTRY}p10
export MMCSD_DEVFS_PARTITION_2=${MMCSD_DEVFS_ENTRY}p11
fi
...
export SYS_SATA_DEVICE=/sys/class/scsi_device
export PROCFS_SWAPS=/proc/swaps
export PROCFS_SCSI=/proc/scsi/scsi
