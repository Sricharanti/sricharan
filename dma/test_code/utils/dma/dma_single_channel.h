...
enum {
EDMA_CCR = 0, EDMA_CLNK_CTRL, EDMA_CICR, EDMA_CSR, EDMA_CSDP,
EDMA_CEN, EDMA_CFN, EDMA_CSSA, EDMA_CDSA, EDMA_CSEI, EDMA_CSFI,
EDMA_CDEI, EDMA_CDFI, EDMA_CSAC, EDMA_CDAC, EDMA_CCEN, EDMA_CCFN,
EDMA_COLOR, EDMA_CH_END
};
#endif
