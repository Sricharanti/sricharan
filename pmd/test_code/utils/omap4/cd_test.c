...
void clock_domain_test()
{
	...
	default:
		...
		printk (" test_id=0x1          - power_test_1             \n");
		printk (" test_id=0x2          - power_test_2             \n");
		printk (" test_id=0x3          - power_test_3             \n");
		printk (" test_id=0x4          - power_test_4             \n");
		printk (" Usage: insmod pd_test.ko test_id=<option>       \n");
		printk (" ******************* HELP ******************* \n");
	}
}
